...
class Process:
    ...
    def influx_simulation(self, param_list: list):
        ...
        """
        # Clear previous results before running a new simulation
    ...
    def _get_influx_sim_res_files(self):
        """
    ...
    def generate_summary(self):
        ...
        if self.tvar_sim_paths :
            ...
            summary_dataframe_styler.to_excel(
                f"{self.results_dir_path}/{self.metabolic_netw_model_name}_summary.xlsx",
                index=False)
